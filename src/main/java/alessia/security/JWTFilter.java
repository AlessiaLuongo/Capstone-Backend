...
private UsersService usersService;
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
       ...
       return   antPathMatcher.match("/auth/**", request.getServletPath()) || antPathMatcher.match("/activities", request.getServletPath()) || antPathMatcher.match("/locations", request.getServletPath());
    }
